    ...
    <div id='Contact' className='bg-white text-black dark:bg-slate-900 dark:text-white p-4 lg:p-20 flex flex-col items-center justify-center'>
      ...
      <div data-aos='fade-up' className='flex flex-col items-center gap-4 mb-10'>
        <div className='flex items-center gap-2'>
          <MdEmail className='text-2xl text-fuchsia-500' />
          <a href="mailto:sushmitajaiswal1000@gmail.com" className='hover:text-fuchsia-500 transition-colors'>
            sushmitajaiswal1000@gmail.com
          </a>
        </div>
        <div className='flex items-center gap-2'>
          <BsTelephoneFill className='text-2xl text-fuchsia-500' />
          <span>+91 9005267069</span>
        </div>
        <div className='flex gap-4 mt-4'>
          <a href="https://www.linkedin.com/in/sushmitajaiswal/" target="_blank" rel="noopener noreferrer" className='hover:text-fuchsia-500 transition-colors'>
            <AiFillLinkedin className='text-3xl' />
          </a>
          <a href="https://github.com/Sjais6165" target="_blank" rel="noopener noreferrer" className='hover:text-fuchsia-500 transition-colors'>
