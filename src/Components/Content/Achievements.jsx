  ...
  const activitiesData = [
    {
      ...
      organization: "NGO",
      date: "2023",
      skills: "Leadership, Project Management, Community Outreach, Women Empowerment",
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 w-full max-w-6xl'>
        {activitiesData.map((activity, index) => (
          ...
          >
            ...
            <p className='text-sm text-gray-500 dark:text-gray-500 mb-2'>{activity.date}</p>
            <p className='text-sm text-primary-600 dark:text-primary-400 mb-4 text-center'>{activity.skills}</p>
            ...
            >
              {expandedId === activity.id ? 'Hide' : 'View'}
            </button>
